  ...
  return (
    <header className="absolute top-0 inset-x-0 z-30">
      <div className="mx-auto max-w-wide px-6 lg:px-8 h-28 flex items-center justify-between">
        ...
        <a href="#contact" className="rounded-full border border-white/70 text-white text-sm font-semibold px-7 py-2.5 hover:bg-white hover:text-ink transition">Contact Us</a>
      </div>
    </header>
  )
}
