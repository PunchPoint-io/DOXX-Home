    ...
    <section id="contact" className="bg-white">
      <div className="grid lg:grid-cols-[2.9fr_1.1fr] items-stretch">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 sm:gap-8 px-6 py-16 lg:py-24 text-center sm:text-left">
          <img src="/assets/mascot-smile.png" alt="" loading="lazy" className="w-40 sm:w-56 shrink-0 select-none" />
          <div>
            <p className="font-display font-extrabold [font-stretch:87%] text-2xl sm:text-[2rem] lg:text-[2.5rem] leading-[1.15] lg:leading-none">
        ...
        <div className="flex flex-col items-center justify-center text-center px-6 py-10 lg:py-16 lg:border-l lg:border-frame">
          <img src="/assets/ig-glyph.png" alt="Instagram" loading="lazy" className="w-28 h-28 select-none" />
