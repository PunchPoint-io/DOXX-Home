      ...
      <div className="quote-grad relative overflow-hidden px-8 lg:px-14 py-14 lg:py-24">
        ...
        <div className="relative grid lg:grid-cols-[1.6fr_1fr] gap-8 items-center">
          <div className="text-white">
            <p className="font-display font-extrabold [font-stretch:87%] text-white/85 text-lg sm:text-2xl xl:text-[2.5rem] xl:leading-none">There are lines that one should never cross</p>
            <p className="mt-3 xl:mt-8 font-display font-extrabold [font-stretch:87%] text-2xl sm:text-3xl lg:text-[2.6rem] xl:text-[3.75rem] leading-snug xl:leading-none">
          ...
          <div className="flex justify-center lg:justify-end lg:pr-10">
            <img src="/assets/mascot-closed.png" alt="" loading="lazy" className="w-40 sm:w-64 drop-shadow-2xl" />
          </div>
        </div>
      </div>
    </section>
