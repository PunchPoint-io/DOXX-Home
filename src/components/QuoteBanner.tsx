export default function QuoteBanner() {
  return (
    <section className="bg-lav border-b border-frame py-10 lg:py-14">
      <div className="quote-grad relative overflow-hidden px-8 lg:px-14 py-14 lg:py-20">
        ...
        <div className="relative grid lg:grid-cols-[1.6fr_1fr] gap-8 items-center">
          <div className="text-white">
            <p className="font-display font-light tracking-[-0.03em] text-white/85 text-lg sm:text-xl xl:text-[2rem] xl:leading-none">There are lines that one should never cross</p>
            <p className="mt-3 xl:mt-6 font-display font-medium tracking-[-0.03em] text-2xl sm:text-3xl lg:text-[2.4rem] xl:text-[3rem] leading-snug xl:leading-none">
