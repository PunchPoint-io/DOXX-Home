    ...
    <section className="hero-grad relative overflow-hidden">
      <div className="mx-auto max-w-wide px-6 lg:px-8 pt-40 pb-24 lg:pt-52 lg:pb-32">
        <div className="grid lg:grid-cols-[1.25fr_0.75fr] gap-8 items-center">
          <h1 className="font-display font-semibold leading-[1.02] tracking-[-0.04em] text-4xl sm:text-5xl lg:text-[4.05rem]">
          ...
          <div className="relative z-10 flex justify-center lg:justify-end lg:translate-y-28">
            <div className="relative">
              <img src="/assets/mascot.png" alt="DO-XX mascot" className="relative z-10 w-56 sm:w-72 lg:w-[29rem] select-none" />
